...
public class Http3Server {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Add fortune route
        router.route(HttpMethod.GET, "/fortunes").handler(ctx -> {
        ...
        Http3ServerBuilder.create()
            ...
            .codec(QuicServerCodecBuilder.create()
...
class Http3ServerHandler extends SimpleChannelInboundHandler<Http3RequestStreamInbound> {
    ...
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, Http3RequestStreamInbound msg) {
        msg.stream().addHandler(new Http3HeadersFrameHandler() {
            @Override
            public void onHeadersRead(ChannelHandlerContext ctx, Http3HeadersFrame frame) {
