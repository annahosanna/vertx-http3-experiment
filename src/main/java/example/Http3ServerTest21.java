...
public class Http3FortuneServer {
            ...
            public void channelRead(ChannelHandlerContext ctx, Object msg) {
                if (msg instanceof io.netty.handler.codec.http.HttpRequest) {
                    ...
                    io.vertx.core.http.HttpServerRequest vertxRequest = 
                        new VertxHttpServerRequestAdapter((io.netty.handler.codec.http.HttpRequest) msg);
    ...
    static class VertxHttpServerRequestAdapter implements io.vertx.core.http.HttpServerRequest {
        private final io.netty.handler.codec.http.HttpRequest nettyRequest;

        public VertxHttpServerRequestAdapter(io.netty.handler.codec.http.HttpRequest request) {
